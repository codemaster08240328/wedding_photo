...
class DashBoard extends Component {
  ...
  getData(param) {
    ...
    if (param["check-in-call"]) {
      const item = {
        ...
        type:
          param["check-in-call"][0].notification_type_data[0]
            .n_type_disp_message,
    ...
    if (param["new-booking"]) {
      const item = {
        ...
        type:
          param["new-booking"][0].notification_type_data[0].n_type_disp_message,
    ...
    if (param["request-payment"]) {
      const item = {
        ...
        type:
          param["request-payment"][0].notification_type_data[0]
            .n_type_disp_message,
    ...
    if (param["request-payment-eng"]) {
      const item = {
        ...
        type:
          param["request-payment-eng"][0].notification_type_data[0]
            .n_type_disp_message,
    ...
    if (param["review-contract"]) {
      const item = {
        ...
        type:
          param["review-contract"][0].notification_type_data[0]
            .n_type_disp_message,
    ...
    if (param["worksheet-updated"]) {
      const item = {
        ...
        type:
          param["worksheet-updated"][0].notification_type_data[0]
            .n_type_disp_message,
    ...
    if (param["worksheet-updated-eng"]) {
      const item = {
        ...
        type:
          param["worksheet-updated-eng"][0].notification_type_data[0]
            .n_type_disp_message,
      ...
      >
        <View style={{ flex: 7 }}>
          <Text style={{ fontSize: 15 }}>
            {item.customer_data[0].cust_fname +
              " " +
              item.customer_data[0].cust_lname}
          </Text>
          <Text style={{ fontSize: 13, color: colors.fontGrayColor }}>
            {item.customer_data[0].cust_addr1 +
              " " +
              item.customer_data[0].cust_city +
              ", " +
              item.customer_data[0].cust_state +
              " " +
              item.customer_data[0].cust_zip}
          </Text>
          <Text style={{ fontSize: 13, color: colors.fontGrayColor }}>
            {item.customer_data[0].cust_wed_date}
          </Text>
        </View>
        <View
          style={{
        ...
        >
          <TouchableOpacity
            ...
            onPress={() => this.pressCallBtn(item.customer_data[0].cust_phone1)}
          >
            <Icon
              name="ios-call"
              type="ionicon"
              ...
              color={colors.white}
            />
            <Text style={{ marginLeft: 5, color: colors.white, fontSize: 13 }}>
              CALL
            </Text>
          </TouchableOpacity>
        ...
        <Modal isVisible={this.state.isModalVisible}>
          ...
          >
            <View style={styles.modal}>
              ...
              >
                <TouchableOpacity
                  onPress={() => this._toggleModal(this.state.selectedItem)}
                >
                  <Icon
                    type="entypo"
              ...
              <View style={{ flex: 1 }}>
                ...
                >
                  <Text style={{ fontSize: 22 }}>
                    {this.state.selectedItem.customer_data
                      ? this.state.selectedItem.customer_data[0].cust_fname +
                        " " +
                        this.state.selectedItem.customer_data[0].cust_lname
                      : ""}
                  </Text>
                </View>
                <View
                ...
                >
                  <View style={{ flex: 6, flexDirection: "row" }}>
                    ...
                    >
                      {this.state.selectedItem.customer_data
                        ? this.state.selectedItem.customer_data[0].cust_city +
                          " " +
                          this.state.selectedItem.customer_data[0].cust_state +
                          ", " +
                          this.state.selectedItem.customer_data[0].cust_zip
                        : ""}
                    </Text>
                  </View>
                ...
                >
                  <View style={{ flex: 1, paddingHorizontal: 3 }}>
                    <TouchableOpacity
                      ...
                      onPress={() =>
                        this.pressCallBtn(
                          this.state.selectedItem.customer_data[0].cust_phone1
                        )
                      }
                    >
                      <Icon name="call" size={15} color={colors.white} />
                      <Text
                        style={{
                          color: colors.white,
                          marginLeft: 5,
                  ...
                  <View style={{ flex: 1, paddingHorizontal: 3 }}>
                    ...
                    >
                      <Icon name="sms" size={15} color={colors.white} />
                      <Text
                        style={{
                          color: colors.white,
                          marginLeft: 5,
                  ...
                  <View style={{ flex: 1, paddingHorizontal: 3 }}>
                    ...
                    >
                      <Icon name="email" size={15} color={colors.white} />
                      <Text
                        style={{
                          color: colors.white,
                          marginLeft: 5,
                ...
                <View
                  style={{ flex: 1, paddingHorizontal: 6, paddingVertical: 1 }}
                >
                  <TouchableOpacity
                    style={{
                      flexDirection: "row",
                    ...
                    onPress={() =>
                      this.MarkNewBookingCallingComplete(
                        this.state.selectedItem
                      )
                    }
                  >
                    <Text style={{ color: colors.white, fontSize: 12 }}>
                      Mark New Booking Call Complete
                    </Text>
                  </TouchableOpacity>
                </View>
                <View
                ...
                >
                  <TouchableOpacity
                    ...
                    onPress={() =>
                      this.MarkPhotoShootCallComplete(this.state.selectedItem)
                    }
                  >
                    <Text style={{ color: colors.white, fontSize: 12 }}>
                      Mark Photoshoot Call Complete
                    </Text>
                  </TouchableOpacity>
                </View>
                <View
                ...
                >
                  <TouchableOpacity
                    ...
                    onPress={() =>
                      this.ScheduleEngagement(this.state.selectedItem)
                    }
                  >
                    <Text style={{ color: colors.white, fontSize: 12 }}>
                      Schedule Engagement Date
                    </Text>
                  </TouchableOpacity>
                </View>
                <View
                ...
                >
                  <TouchableOpacity
                    ...
                    onPress={() =>
                      this.WeddingWorksheet(this.state.selectedItem)
                    }
                  >
                    <Text style={{ color: colors.white, fontSize: 12 }}>
                      View Wedding Worksheet
                    </Text>
                  </TouchableOpacity>
                </View>
                <View
                ...
                >
                  <TouchableOpacity
                    ...
                    onPress={() =>
                      this.EngagementWorksheet(this.state.selectedItem)
                    }
                  >
                    <Text style={{ color: colors.white, fontSize: 12 }}>
                      View Engagement Worksheet
                    </Text>
                  </TouchableOpacity>
                </View>
                <View
                ...
                >
                  <TouchableOpacity
                    ...
                    onPress={() =>
                      this.WeddingPayRequest(this.state.selectedItem)
                    }
                  >
                    <Text style={{ color: colors.white, fontSize: 12 }}>
                      Request Wedding Pay
                ...
                >
                  <TouchableOpacity
                    ...
                    onPress={() =>
                      this.EngagementPayRequest(this.state.selectedItem)
                    }
                  >
                    <Text style={{ color: colors.white, fontSize: 12 }}>
                      Request Engagement Pay
                    </Text>
                  </TouchableOpacity>
                </View>
              </View>
  ...
  componentWillReceiveProps(nextProps) {
    if (
      nextProps.weddingPaymentRequestReducer.success &&
      Object.keys(nextProps.weddingpayreq).length == 2
    ) {
      const param = {
        customer: this.state.selectedItem
      };
      ...
      this.refs.toast.show(
        nextProps.weddingPaymentRequestReducer.message,
        2000
      );
    }

    if (
      nextProps.engagementPaymentRequestReducer.success &&
      Object.keys(nextProps.engagementPayReq).length == 2
    ) {
      const param = {
        customer: this.state.selectedItem
      };
      ...
      this.refs.toast.show(
        nextProps.engagementPaymentRequestReducer.message,
        2000
      );
    }
  }
  ...
  render() {
    const menu = (
      <Menu onItemSelected={this.onMenuItemSelected} {...this.props} />
    );
    let data = [];
        ...
        <View style={styles.container}>
          ...
          >
            ...
            >
              <View
                style={
                  this.props.dashReducer.dashboard &&
                  this.props.dashReducer.dashboard["check-in-call"]
                    ? {
                        justifyContent: "center",
                        alignItems: "center",
                        height: 12,
              ...
              >
                ...
                >
                  {this.props.dashReducer.dashboard &&
                  this.props.dashReducer.dashboard["check-in-call"]
                    ? this.props.dashReducer.dashboard["check-in-call"].length
                    : 0}
                </Text>
              </View>
            ...
            >
              <View
                style={
                  this.props.dashReducer.dashboard &&
                  this.props.dashReducer.dashboard["new-booking"]
                    ? {
                        justifyContent: "center",
                        alignItems: "center",
                        height: 12,
              ...
              >
                ...
                >
                  {this.props.dashReducer.dashboard &&
                  this.props.dashReducer.dashboard["new-booking"]
                    ? this.props.dashReducer.dashboard["new-booking"].length
                    : 0}
                </Text>
              </View>
              <View style={{ marginTop: -5 }}>
            ...
            >
              <View
                style={
                  this.props.dashReducer.dashboard &&
                  this.props.dashReducer.dashboard["worksheet-updated"]
                    ? {
                        justifyContent: "center",
                        alignItems: "center",
                        height: 12,
            ...
            >
              <View
                style={
                  this.props.dashReducer.dashboard &&
                  this.props.dashReducer.dashboard["request-payment"]
                    ? {
                        justifyContent: "center",
                        alignItems: "center",
                        height: 12,
              ...
              >
                ...
                >
                  {this.props.dashReducer.dashboard &&
                  this.props.dashReducer.dashboard["request-payment"]
                    ? this.props.dashReducer.dashboard["request-payment"].length
                    : 0}
                </Text>
              </View>
          ...
          <View>
            <SectionList
              ...
              renderSectionHeader={({ section }) =>
                this.renderHeaderSection(section)
              }
              sections={data}
              contentContainerStyle={{ paddingBottom: 80 }}
              ListFooterComponent={
                <View style={{ height: 0, marginBottom: 100 }} />
              }
            />
          </View>
        </View>
